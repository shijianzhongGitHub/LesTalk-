...
- (UIView *)coverView
{
    if (_coverView == nil) {
        ...
        coverView.backgroundColor = _coverColor?_coverColor:[UIColor colorWithRed:196/255.0 green:247/255.0 blue:232/255.0 alpha:1.0];
...
- (UIScrollView *)titleScrollView
{
    if (_titleScrollView == nil) {
        ...
        titleScrollView.backgroundColor = _titleScrollViewColor?_titleScrollViewColor:[UIColor colorWithRed:196/255.0 green:247/255.0 blue:232/255.0 alpha:1.0];
        
        [self.contentView addSubview:titleScrollView];
        
        UIButton * dropDownBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        dropDownBtn.frame = CGRectMake(SCREEN_WIDTH-45, 0, 45, 64);
...
//    self.navTitleView = [[UIView alloc] init];
//    self.navTitleView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 64);
//    self.navTitleView.backgroundColor = MintGreenColor;
//    [self.view addSubview:self.navTitleView];
//    
//    UIButton * enterBtn = [UIButton buttonWithType:UIButtonTypeCustom];
//    enterBtn.frame = CGRectMake(SCREEN_WIDTH-45, 0, 45, 64);
//    enterBtn.backgroundColor = MintGreenColor;
//    [enterBtn setTitle:@"进入" forState:UIControlStateNormal];
//    [enterBtn setImage:[UIImage imageNamed:@"进入-(3)"] forState:UIControlStateNormal];
//    [enterBtn setImageEdgeInsets:UIEdgeInsetsMake(22, 0, 0, 0)];
//    [enterBtn addTarget:self action:@selector(enterBtnClick:) forControlEvents:UIControlEventTouchUpInside];
//    [self.navTitleView addSubview:enterBtn];
//    
//    UILabel * navTitleLabel = [[UILabel alloc] init];
//    navTitleLabel.frame = CGRectMake(0, 20, SCREEN_WIDTH, 44);
//    navTitleLabel.textColor = [UIColor blackColor];
//    navTitleLabel.text = @"匹配";
//    navTitleLabel.font = [UIFont systemFontOfSize:16];
//    navTitleLabel.textAlignment = NSTextAlignmentCenter;
//    [self.navTitleView addSubview:navTitleLabel];
}
...
- (void)setUpAllTitle
{
    ...
    // 添加所有的标题
    CGFloat labelW = 0;
    CGFloat labelH = self.titleHeight+24;
    CGFloat labelX = 0;
    CGFloat labelY = 10;
