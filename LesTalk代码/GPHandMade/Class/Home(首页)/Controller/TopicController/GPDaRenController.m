...
{
     NSString *CellInentifier=@"Cell";
    
    GPDarenCell *daRenCell = [tableView dequeueReusableCellWithIdentifier:CellInentifier];
   
    if (daRenCell == nil)
    {
        daRenCell = [[GPDarenCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellInentifier];
    }
